...
> 状态（2026-08-03）：本文关于 Task 可见性、项目成员 Reviewer、Revision 直通和自审策略的决策已由 [Task 全员可见、双成员角色与全局管理员审批](./2026-08-03-task-global-visibility-participants-admin-approval.md) 取代，仅保留历史背景。
>
