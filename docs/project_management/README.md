...
- `/progress` 已开放项目管理入口，包含 Project、我的工作总览、Task 列表/工作台、人员计划、个人时间线和站内通知中心。Project 是 Task 上层文件夹和立项对象，不恢复 Stage。
...
- `WorkSegment` 不再保存或展示投入比例；多个 Segment 可以时间重叠，系统不检测、提示、阻止或通知资源冲突。
