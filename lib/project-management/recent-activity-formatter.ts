...
const ACTION_DEFINITIONS = {
  ...
  "pm.termination.confirm": ["PLAN_NODE", "确认了 Task 结束节点"],
  "pm.segment.create": ["TASK", "新增了人员投入"],
  "pm.segment.update": ["TASK", "修改了人员投入"],
  "pm.segment.split": ["TASK", "拆分了人员投入"],
  "pm.segment.merge": ["TASK", "合并了人员投入"],
  "pm.segment.confirm": ["TASK", "确认了人员投入"],
  "pm.segment.cancel": ["TASK", "取消了人员投入"],
