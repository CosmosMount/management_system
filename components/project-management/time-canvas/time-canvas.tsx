...
const ADMIN_MARKER_STAGE_HEIGHT = 92;
const GLOBAL_MARKER_LABEL_TOP = 5;
const GLOBAL_MARKER_LANE_STRIDE = 22;
...
function AdminGlobalMarkerStage({
  markers,
  scale,
  visibleWindow,
  dayStripes,
