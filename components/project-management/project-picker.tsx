...
export function ProjectSelect({ value, onValueChange, initialOptions = EMPTY_PROJECT_OPTIONS, disabled = false, inputId, ariaLabel = "选择所属项目", placeholder = "搜索项目", invalid = false, ariaDescribedBy }: { value: string | null; onValueChange: (value: string | null) => void; initialOptions?: ProjectOption[]; disabled?: boolean; inputId?: string; ariaLabel?: string; placeholder?: string; invalid?: boolean; ariaDescribedBy?: string }) {
